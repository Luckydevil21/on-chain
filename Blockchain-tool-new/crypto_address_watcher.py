...
# instead, so this file (and the Excel report below) survive
# restarts/redeploys:
...
# --------------------------------------------------------------
OUTPUT_EXCEL_FILE = os.path.join(TOOLKIT_DATA_DIR, "crypto_addresses_report.xlsx")
...
ADDRESS_PATTERNS = [
    ...
    (r"\bT[a-km-zA-HJ-NP-Z1-9]{33}\b", "Tron (USDT-TRC20/TRX)"),
]
