...
# ====================================================================
# SECTION 7E: KNOWN OP_RETURN PATTERNS (rotating-address services)
# ====================================================================
# For Bitcoin services that use a NEW receiving address every
# transaction (so known_entities.json's exact-address matching can
# never keep up), this recognizes the service by a consistent message
# it embeds in the transaction's OP_RETURN output instead.
