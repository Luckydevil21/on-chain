...
def trace_forward(victim_wallet, target_lowercase_set, max_hops, starting_amount=None, exact_amount_only=False):
    """
...
def trace_backward(start_wallet, target_lowercase_set, max_hops, starting_amount=None, exact_amount_only=False):
    """
